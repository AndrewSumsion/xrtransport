 ...
 */
void on_init(xrtransport::Transport* transport, xrtransport::FunctionLoader* function_loader);
 ...
 */
void get_required_extensions(std::uint32_t* num_extensions_out, const char** extensions_out);
 ...
 */
void on_instance(xrtransport::Transport* transport, xrtransport::FunctionLoader* function_loader, XrInstance instance);
